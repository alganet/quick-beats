    ...
    return (
        <div className="flex items-center justify-center gap-3 animate-in fade-in h-full">
            ...
            <button
                ...
                className="text-[10px] font-mono text-slate-500 hover:text-slate-300 bg-white/5 hover:bg-white/10 border border-white/10 px-2.5 py-0.5 transition-all uppercase tracking-wider"
            >
                No
            </button>
        </div>
