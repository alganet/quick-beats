...
export default function ErrorModal({ isOpen, onGoHome }) {
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-overlay/90 backdrop-blur-sm animate-in fade-in duration-200">
            <div
                className="w-full max-w-md bg-surface-2 border border-red-900/50 p-8 shadow-2xl animate-in zoom-in-95 duration-200"
            ...
            >
                <div className="flex flex-col items-center text-center mb-8">
                    ...
                    <h2 className="text-2xl font-black tracking-tighter text-fg uppercase mb-2">
                        Oops...
                    </h2>
                ...
                <button
                    onClick={onGoHome}
                    className="w-full py-4 bg-red-600 hover:bg-red-500 text-fg text-xs font-black uppercase tracking-widest transition-all"
                >
                    Go Home & Refresh
                </button>
            </div>
