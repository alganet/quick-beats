...
export default function Setup({ onSelect, onConfirm, selectedSig, onShowHelp }) {
    return (
        <div className="min-w-[360px] z-40 min-h-screen w-full flex flex-col items-center justify-start md:justify-center bg-[#0a0a0a] p-6 overflow-y-auto py-12 md:py-6 relative">
            <button
                onClick={onShowHelp}
            ...
            <div className="max-w-2xl w-full">
                <div className="text-center mb-8 md:mb-16">
                    <h1 className="text-3xl font-black tracking-tighter text-white mb-4 uppercase flex items-center justify-center gap-3">
                ...
                {/* Confirm Button Area */}
                <div className="absolute mt-6 flex items-center justify-center fixed bottom-0 w-full left-0 p-4 pt-20 bg-gradient-to-t from-[#0a0a0a] to-transparent pointer-events-none">
                    {selectedSig && (
                        <button
                            onClick={onConfirm}
                            className="z-50 relative w-full md:w-64 bg-[#3b82f6] text-white font-black py-4 hover:bg-[#2563eb] transition-all tracking-[0.3em] uppercase text-sm animate-in fade-in slide-in-from-bottom-2 duration-300 pointer-events-auto"
                        >
                            Confirm & Start
                        </button>
                    )}
