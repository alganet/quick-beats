...
export const IconSprite = () => (
    <svg xmlns="http://www.w3.org/2000/svg" style={{ display: 'none' }}>
        ...
        {/* Install: a down-arrow into a tray (add to home screen / install app) */}
        <symbol id="icon-install" viewBox="0 0 24 24">
            ...
            <path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2" stroke="currentColor" strokeWidth="2" strokeLinecap="round" fill="none" />
        </symbol>
